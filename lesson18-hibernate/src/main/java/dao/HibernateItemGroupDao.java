...
public class HibernateItemGroupDao extends AbstractHibernateDao implements ItemGroupDao {
	...
	// Creates a ResultTransformer that will inject aliased values into instances of
	// Class via property methods or fields.
	...
	public void demoSlvCache() {
		...
		ItemGroup igA = session1.get(ItemGroup.class, 1);
