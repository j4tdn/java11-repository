...
public class ItemDetail {
	...
	//Extra columns
	// NN table has extra column >> cannot use @ManyToMany >> create entity for NN table
	...
	public ItemDetail(Id id, String image, Double salesPrice, Double originPrice, Integer amount) {
		this.id = id;
		this.image = image;
	...
	public String toString() {
		return "ItemDetail [id=" + id + ", image=" + image + ", salesPrice=" + salesPrice + ", originPrice="
				+ originPrice + ", amount=" + amount + "]";
	}

	// Nested class
	@Embeddable  // serialize // deserialize
