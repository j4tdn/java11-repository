...
public class App {
	...
	public static void main(String[] args) {
		...
		// Câu 2a: Lấy các mặt hàng của từng loại hàng
		breakLine("Câu 2a: Lấy các mặt hàng của từng loại hàng");
		...
		List<ItemDetail> itemDetails = firstItem.getItemDetail();
		...
		breakLine("Câu 3: Liệt kê tất cả các mặt hàng theo mã mặt hàng");
