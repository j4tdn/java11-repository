...
public class ItemDaoImpl implements ItemDao {
	...
	public List<Item> get(String igName) {
		...
		try {
			...
			while (rs.next()) {
				...
				Item item = new Item(rs.getInt("MaLH"), rs.getString("TenMH"), rs.getString("MauSac"), group);
				result.add(item);
	...
	public List<Item> get(LocalDate orderDate) {
		...
		try {
			...
			rs = pst.executeQuery();
			while (rs.next()) {
				Item item = new Item(rs.getInt("MaLH"), rs.getString("TenMH"), rs.getString("MauSac"));
				result.add(item);
