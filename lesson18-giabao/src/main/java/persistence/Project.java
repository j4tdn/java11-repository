...
public class Project {
    ...
    private List<ProjectEmployee> project_employees;

    public List<ProjectEmployee> getProject_employees() {
        return project_employees;
    }

    public void setProject_employees(List<ProjectEmployee> project_employees) {
