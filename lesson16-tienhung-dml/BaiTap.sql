1. Toàn bộ thông tin các loại hàng
    -- Mặt hàng thuộc loại hàng là 'Thắt lưng' 
          Select *from mathang where MaLH in (Select  MaLH from  loaihang where TenLH='Thắt lưng'
    -- Top 5 mặt hàng có giá bán cao nhất
	       Select DISTINCT mamh from chitietmathang order by GiaBan desc limit 5;
2. Đơn hàng
    ...
    -- Được bán từ ngày 28/11/2019 đến ngày 02/12/2019
     Select * from donhang
    where cast(thoigiandathang as date) >= '2019-11-28' and cast(thoigiandathang as date)<='2019-12-2';
...
select mamh, GiaBan*0.8 as GiaSauKhuyenMai from chitietmathang;
...
select l.malh,l.tenlh, count(m.mamh) as SoLuong
from loaihang l
