...
public class App {
	public static void main(String[] args) {
		/*
		 * c1: KH1, Adam, 123, NewYork c2: KH2, Kate, 234, California
		 * 
		 * i1: SS10+, Android, Black, 620 i2: SS20U, Android, Green, 840 i3: IP4, IOS,
		 * While, 280 i4: IP12, IOS, Black, 880 i5: WP8, WindowPhone, Blue, 560
		 */
		/*
		...
		System.out.println("Order 2: " + OrderUtils.export(o1));
		System.out.println("Order 3: " + OrderUtils.export(o1));
		
		// Write method export in Order class: no parameter
		// Write method export is Another class: export (order)
	}
}
