...
public class App {
	public static void main(String[] args) {
		...
		Customer c2 = new Customer("KH2", "Kate", "243", "Cali");

		Item i1 = new Item("SS10+", "Adroid", "Black", 620);
		Item i2 = new Item("SS20U", "Adroid", "Grean", 840);
		...
		Order o2 = new Order(c2, new ItemDetail[] { new ItemDetail(i3, 2), new ItemDetail(i5, 3), },
