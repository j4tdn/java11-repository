...
public class App {
	...
	public static void main(String[] args) {
		...
		Customer c2 = new Customer("KH2", "Kate", "245", "California");
		...
		Order o2 = new Order(c2, new ItemDetail[] { new ItemDetail(i3, 3), new ItemDetail(i5, 1) },
		...
		System.out.println(OrderUtils.export(o1));
		System.out.println(OrderUtils.export(o2));
		System.out.println(OrderUtils.export(o3));
	}
}
