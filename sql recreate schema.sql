...
/*!40000 ALTER TABLE `chitietdonhang`
    DISABLE KEYS */;
...
/*!40000 ALTER TABLE `chitietmathang`
    DISABLE KEYS */;
INSERT INTO `chitietmathang`
VALUES (1, 'L', 'undefined.png', 240, 220, 80),
...
/*!40000 ALTER TABLE `chitiettinhtrangdonhang`
    DISABLE KEYS */;
INSERT INTO `chitiettinhtrangdonhang`
VALUES (1, 3, 2, '2020-12-14 18:20:20'),
       (1, 4, 2, '2020-12-15 18:20:20'),
       (1, 5, 2, '2020-12-16 18:20:20'),
       (2, 3, 2, '2020-12-14 18:20:20'),
       (2, 4, 2, '2020-12-15 18:20:20'),
       (2, 5, 2, '2020-12-16 18:20:20'),
       (3, 3, 2, '2020-12-14 18:20:20'),
       (3, 4, 2, '2020-12-15 18:20:20'),
       (3, 5, 2, '2020-12-16 18:20:20');
/*!40000 ALTER TABLE `chitiettinhtrangdonhang`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `loaihinhthanhtoan`
    DISABLE KEYS */;
INSERT INTO `loaihinhthanhtoan`
VALUES (1, 'Cash'),
       (2, 'Visa Card');
/*!40000 ALTER TABLE `loaihinhthanhtoan`
    ENABLE KEYS */;
...
/*!40000 ALTER TABLE `mathang`
    DISABLE KEYS */;
INSERT INTO `mathang`
VALUES (1, 'Áo sơ mi Nam', 'Trắng', 1),
       (2, 'Áo sơ mi Nữ', 'Đen', 1),
       (3, 'Quần tây Nam', 'Xanh', 2),
       (4, 'Quần jean Nam', 'Nâu', 2),
       (5, 'Quần jean Nữ', 'Trắng', 2),
       (6, 'Giày da Nam', 'Đen', 3),
       (7, 'Giày thể thao Nữ', 'Vàng', 3),
       (8, 'Thắt lưng Nam', 'Hồng', 4),
       (9, 'Thắt lưng Nữ', 'Xanh', 4),
       (10, 'Mũ thể thao Nam', 'Trắng', 5),
       (11, 'Áo khoác', 'Hồng', 1),
       (12, 'Áo khoác', 'Trắng', 1);
/*!40000 ALTER TABLE `mathang`
    ENABLE KEYS */;
...
/*!40000 ALTER TABLE `nhanvien`
    DISABLE KEYS */;
INSERT INTO `nhanvien`
VALUES (1, 'Lê Tèo', 'com1.default.tp@gmail.com', 'Nam Cao - Hòa Khánh - Đà Nẵng', '0936 978 033',
        '827ccb0eea8a706c4c34a16891f84e7b', 1),
       (2, 'Lê Na', 'com2.default.tp@gmail.com', 'Âu Cơ - Hòa Khánh - Đà Nẵng', '0936 978 033',
        'adcaec3805aa912c0d0b14a81bedb6ff', 2),
       (3, 'Hoàng Bửi', 'com3.default.tp@gmail.com', 'Nam Cao - Hòa Khánh - Đà Nẵng', '0936 978 033',
        '992a6d18b2a148cf20d9014c3524aa11', 2),
       (4, 'Ngọc Thành', 'com4.default.tp@gmail.com', 'Lê Độ - Hòa Khánh - Đà Nẵng', '0936 978 033',
        'c4ded2b85cc5be82fa1d2464eba9a7d3', 3),
       (5, 'Công Danh', 'com5.default.tp@gmail.com', 'Nam Cao - Hòa Khánh - Đà Nẵng', '0936 978 033',
        '099ebea48ea9666a7da2177267983138', 3);
/*!40000 ALTER TABLE `nhanvien`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `tinhtrangdonhang`
    DISABLE KEYS */;
INSERT INTO `tinhtrangdonhang`
VALUES (1, 'Yêu cầu đặt hàng'),
