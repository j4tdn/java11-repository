...
public class FileUtils {
	...
	public static void moveFile(String currentPath, String newPath, Extension ext) {
		File moveFile = new File(currentPath);
		
		File[] file = moveFile.listFiles(new FileFilter() {
			
			@Override
			public boolean accept(File file) {
				return file.isFile() && file.getName().endsWith(ext.val()) ;
			}
		});
