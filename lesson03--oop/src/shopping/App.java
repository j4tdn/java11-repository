...
public class App {
	public static void main(String[] args) {
		...
		ItemDetail[] ids = new ItemDetail[] { new ItemDetail(i1, 3), new ItemDetail(i4, 5), new ItemDetail(i2, 1) };
		ItemDetail[] ids1 = new ItemDetail[] { new ItemDetail(i3, 2), new ItemDetail(i5, 1), };
		ItemDetail[] ids2 = new ItemDetail[] { new ItemDetail(i4, 1), };

		Order o1 = new Order(c1, ids, LocalDateTime.of(2021, 5, 8, 10, 10, 10));
		Order o2 = new Order(c2, ids1, LocalDateTime.of(2021, 5, 7, 20, 10, 12));
		Order o3 = new Order(c2, ids2, LocalDateTime.of(2021, 5, 8, 9, 28, 32));
