...
--	1       Giày    20
--	2       Áo      28
select m.MaLH, TenLH, sum(n.SoLuong) as SoLuong from MatHang m 
			inner Join loaihang p On m.maLH = p.MaLH
			inner Join ChiTietDonHang n On m.maMH = n.maMH
            group by m.MaLH; 
...
select d.MaDH, sum(n.GiaBan * p.SoLuong) as TotalPrice from donhang d
