			...
			<tbody>
				<c:forEach var="customer" items="${customers}">
					<tr>
						...
						<td>
							<a href="${pageContext.request.contextPath}/customer/update?id=${customer.id}" class="btn btn-info btn-sm">Update</a> 
							<a href="${pageContext.request.contextPath}/customer/delete?id=${customer.id}" class="btn btn-danger btn-sm"
							 onclick="if(!confirm('Ban chac muon xoa nguoi nay khong ?')) return false">Delete</a>
						</td>
					</tr>
				</c:forEach>
