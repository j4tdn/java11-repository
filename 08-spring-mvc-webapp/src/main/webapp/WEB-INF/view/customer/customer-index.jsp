...
<body>
		...
		<nav class="navbar navbar-light bg-light navbar-expand-lg">
			<div class="container-fluid">
				<button class="navbar-toggler" type="button"
					data-bs-toggle="collapse" data-bs-target="#navbarTogglerId"
					aria-controls="#navbarTogglerId" aria-expanded="false"
					aria-label="Toggle navigation">
					<span class="navbar-toggler-icon"></span>
				</button>
				<a class="navbar-brand" href=""> <svg
						xmlns="http://www.w3.org/2000/svg" width="42" height="32"
				...
				<div class="collapse navbar-collapse" id="#navbarTogglerId">
					...
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						<li class="nav-item"><a class="nav-link"
							class="customer-page" aria-current="page" href="">Customer</a></li>
						<li class="nav-item"><a class="nav-link" href="#">Stuff</a></li>
						<li class="nav-item"><a class="nav-link" href="#"
							tabindex="-1" aria-disabled="true">Admin</a></li>
					</ul>

					<form:form action="" method="GET" class="d-flex">
						<input name="text" value="" class="form-control me-2"
	...
	<main class="container-fluid">
		<a href="" class="btn btn-primary btn-sm mt-3 mb-3"> <i
	...
	<footer class="bg-light fixed-bottom py-3 text-center">
		<div class="container-fluid">
			<span class="text-muted">CMA made with JAVA11 &#129392;
				25.06.2022</span>
		</div>
	</footer>
