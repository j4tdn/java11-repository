...
public class Ex03 {
	public static void main(String[] args) {
		...
		List<Employee> tlist = Arrays.asList(new Employee(31, "E", 50, 3), new Employee(32, "F", 10, 3));
		...
		teams.put(new Employee(1, "Jonh", 100, null), flist);
		teams.put(new Employee(2, "Smith", 150, null), slist);
		teams.put(new Employee(3, "Andy", 150, null), tlist);
		
		teams.put(new Employee(1, "Jonh", 100, null), tlist);
