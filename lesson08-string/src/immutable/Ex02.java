...
public class Ex02 {
	public static void main(String[] args) {
		...
		//so sanh: 
		//==(stack) 
		//Object#equals (default-stack-variabl, being overide-value)
		...
		System.out.println("s1 eq o1" + (s1.equals(o1)));//false
		System.out.println("o1 eq o2" + (o1.equals(o2)));//false	
		System.out.println("o1 eq o3" + (o1.equals(o3)));//false
		System.out.println("o2 eq o3" + (o2.equals(o3)));//true
