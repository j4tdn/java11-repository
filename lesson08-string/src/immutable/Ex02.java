...
public class Ex02 {
	public static void main(String[] args) {
		...
		System.out.println("(l1 cpt l2): " + (l1.compareTo(l2))); // F
		System.out.println("(l1 cpt l3): " + (l1.compareTo(l3))); // F
		System.out.println("(l1 cpt l4): " + (l1.compareTo(l4))); // F
		System.out.println("(l2 cpt l4): " + (l2.compareTo(l4))); // T
		
		System.out.println("(o1 cpt o2): " + (o1.compareTo(o2))); // F
		System.out.println("(o1 cpt o3): " + (o1.compareTo(o3))); // F
		System.out.println("(o1 cpt o4): " + (o1.compareTo(o4))); // F
